        ...
        >
          ...
          <motion.div variants={fadeInUp} className="relative overflow-hidden rounded-3xl border border-border/60 bg-[#0a1628] p-8 md:p-10 shadow-xl shadow-black/10 mb-8">
            ...
            <div className="relative z-10">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
                Built for <span className="font-serif italic text-white">Archival Excellence</span>
              </h1>
              <p className="text-white/70 leading-relaxed max-w-3xl">
                Explore the advanced digital archiving capabilities, reliable preservation infrastructure, and user-centric access controls built into iArchive. Our platform adheres to strict institutional protocols and international archival standards.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div id="features" variants={fadeInUp} className="mb-8">
            <div className="text-center mb-10">
              <p className="text-[10px] font-bold text-[#4169E1] uppercase tracking-[0.2em] mb-3">Key Features</p>
              <h2 className="text-3xl font-bold text-[#0a1628]">
                System <span className="font-serif italic text-[#4169E1]">Capabilities</span>
              </h2>
            </div>
